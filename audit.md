...
- [x] ~~**WebAssembly backend**~~ ✅ `compileToWasm()` / `compileToWat()` — IR → WAT text + WASM binary (pure TS encoder, no deps). Supports i32/f64 arithmetic, locals, function calls, exports. `WebAssembly.instantiate` verified.
